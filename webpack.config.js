...
module.exports = {
    ...
    output: {
        ...
        // library means that the exports from the entry file can be accessed from outside, in this case from the global scope as window.ElidinisHelper
        library: { type: "umd", name: "ElidinisHelper" }
    },
    devtool: false,
    mode: "development",
